...
[`@aws-sdk/client-evidently`](https://www.npmjs.com/package/@aws-sdk/client-evidently/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-evidently@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XTC7R17E6AQuDB1u5ucfec4JiydJAupo6tOxkaYi+U3tFY+Ptvp7thIIOkd9KMZG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-evidently": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-evidently@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-evidently@3.817.0/index.min.mjs": "sha384-XTC7R17E6AQuDB1u5ucfec4JiydJAupo6tOxkaYi+U3tFY+Ptvp7thIIOkd9KMZG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-evidently/blob/refs/tags/3.817.0/LICENSE
```
